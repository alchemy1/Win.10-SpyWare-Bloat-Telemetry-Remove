...
In case you want **to put things back, [HERE's] (https://github.com/komodev/RemoveW10Bloat/PutBackW10Bloat.bat.txt "UNDO PROCES SCRIPT - DOWNLOAD FROM HERE"). The reverse script (remove the ".txt" extension and run as Admin).**
